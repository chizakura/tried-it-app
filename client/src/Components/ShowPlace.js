...
class ShowPlace extends Component{
    ...
    async componentDidMount(){
        const response = await axios.get(`/places/${this.props.match.params.id}`);
        const place = response.data.place;
        const usersIdResponse = await axios.get(`/reviews/findPlaceUsers/${this.props.match.params.id}`);
